 ...
 * Author: Evga314
 *
 * Icon position uses 0–1000 coordinates (decimals allowed).
 */
public final class BloodVignetteHud {
    ...
    public static void renderVignette(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
        ...
        if (IconPositionScreen.active) return;
        ...
        float alpha = (0.25f + 0.55f * pulse * (0.4f + 0.6f * danger)) * act * BloodVignetteConfig.vignetteOpacity;
    ...
    public static void renderWarningIcon(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
        ...
        float x = width * (BloodVignetteConfig.iconPosX / 1000f) - iconSize / 2f;
        float y = height * (BloodVignetteConfig.iconPosY / 1000f) - iconSize / 2f;
